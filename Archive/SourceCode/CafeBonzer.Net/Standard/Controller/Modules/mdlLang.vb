...
Module mLanguage
	...
	Public Const CbMsgApp As String = "CafeBonzer"
	Public Const CbMsgWarn As String = "CafeBonzer Warning !"
	...
	Function LangPrcs(ByRef Text As String) As String
		' %sa% = Selected Agent
		' %cn% = Customer Name
		...
		Text = Replace(Text, "%exdt%", CStr(Tarikh))
		LangPrcs = Replace(Text, "%extm%", CStr(TimeOfDay))
	End Function
	...
	Function LangParam(ByRef Text As String, ParamArray ByVal SeqParam() As Object) As String
