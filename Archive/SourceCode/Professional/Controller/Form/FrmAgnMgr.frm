...
Private Sub MainPhld_PageFlip(ByVal Collapse As Boolean)
...
Private Function LoadAgents() As Long
    Dim mLv As ListView, mItm As ListItem
    ...
    For a% = 1 To mLv.ListItems.Count
        Set mItm = mLv.ListItems(a%)
        Set nItm = LstVw1.ListItems.Add(, mItm.Text, mItm.Text)
