...
Private Sub Text2_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii = 13 And Text2.Text <> "" Then
        ProcessIn
    End If
    If KeyAscii = 27 Then FrmTerminal.Hide: CbConsole = False: Set FrmTerminal = Nothing
End Sub
...
Public Sub Fetch(arahan As String)
    If arahan = "/debug" Then FrmDbg.Show: Exit Sub
    If arahan = "/flush" Then FrmTerminal.List1.Clear: Exit Sub
