...
' hook.
'
' This module plus the implementation class IHookWindows.cls
...
Dim hInstance As Long
   ...
   If (m_hHook(eType) <> 0) Then
      ...
      End If
      ' Success:
      debugmsg "CasHookWin: Number of attached: " & m_iConsumerCount
      InstallHook = True
   End If
