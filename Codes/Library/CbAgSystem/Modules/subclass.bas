Attribute VB_Name = "CasGenSubclass"
Option Explicit
...
Sub AttachMessage(iwp As CasGenISubclass, ByVal hWnd As Long, _
                  ByVal iMsg As Long)
...
Sub DetachMessage(iwp As CasGenISubclass, ByVal hWnd As Long, _
                  ByVal iMsg As Long)
    Dim procOld As Long, f As Long, c As Long
...
Private Function WindowProc(ByVal hWnd As Long, ByVal iMsg As Long, _
    ...
    Dim iwp As CasGenISubclass, iwpT As CasGenISubclass
