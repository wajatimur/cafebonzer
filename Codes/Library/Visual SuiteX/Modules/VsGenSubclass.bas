Attribute VB_Name = "VsGenSubclass"
Option Explicit
...
Sub AttachMessage(iwp As VsGenISubclass, ByVal hwnd As Long, _
                  ByVal iMsg As Long)
...
Sub DetachMessage(iwp As VsGenISubclass, ByVal hwnd As Long, _
                  ByVal iMsg As Long)
    Dim procOld As Long, f As Long, c As Long
...
Private Function WindowProc(ByVal hwnd As Long, ByVal iMsg As Long, _
    ...
    Dim iwp As VsGenISubclass, iwpT As VsGenISubclass
