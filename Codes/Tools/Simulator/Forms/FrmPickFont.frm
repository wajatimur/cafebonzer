...
Begin VB.Form FrmPickFont 
   ...
   Begin VB.ListBox FntSize 
      ...
      Width           =   1320
   End
   Begin CafeBonzerAGSim.uLine3D uLine3D1 
      Height          =   45
      Left            =   30
      TabIndex        =   5
      Top             =   2100
   ...
   Begin VB.ListBox FntList 
      ...
      Width           =   1950
   End
   Begin CafeBonzerAGSim.chameleonButton btnFntPick1 
      Height          =   390
      Left            =   3765
      TabIndex        =   3
      ...
      VALUE           =   0   'False
   End
   Begin CafeBonzerAGSim.chameleonButton btnFntPick2 
      Height          =   390
      Left            =   3270
      TabIndex        =   4
